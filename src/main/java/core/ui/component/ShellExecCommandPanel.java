...
public class ShellExecCommandPanel extends JPanel {
   ...
   public ShellExecCommandPanel(ShellEntity shellEntity) {
      ...
      ShellExecCommandPanel.textareaFocus f_listener = new ShellExecCommandPanel.textareaFocus((ShellExecCommandPanel.textareaFocus)null);
      this.addFocusListener(f_listener);
      ShellExecCommandPanel.textareaKey key_listener = new ShellExecCommandPanel.textareaKey((ShellExecCommandPanel.textareaKey)null);
   ...
   private class textareaFocus extends FocusAdapter {
      ...
      // $FF: synthetic method
      textareaFocus(ShellExecCommandPanel.textareaFocus var2) {
         this();
      }
   }
   ...
   private class textareaKey extends KeyAdapter {
      ...
      // $FF: synthetic method
      textareaKey(ShellExecCommandPanel.textareaKey var2) {
         this();
      }
   }
}
