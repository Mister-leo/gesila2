...
public class ApplicationContext {
   ...
   private static HashMap<String, Class<?>> payloadMap;
   private static HashMap<String, Class<?>> cryptionMap;
   private static HashMap<String, Class<?>> pluginMap;
   ...
   private static int scanClassX(URI uri, String packageName, Class<?> parentClass, Class<?> annotationClass, Map<String, Class<?>> destMap) {
       // 运行的时候是通过jar 扫描，debug时通过
      if (System.getProperty("debug") != "1" &System.getProperty("java.class.path").endsWith(".jar") && System.getProperty("java.class.path").indexOf(";") == -1) {
